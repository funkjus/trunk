...
//
//public class TradersListTest {
//    public static TradersList tradersList;
//    public static EntityStorage entity;
//
//    @Before
...
//        tradersList = new TradersList(entity);
//    }
//
//    @After
...
//        int testSize = tradersList.getSize();
//        int count = 0;
//        for (Trader t : entity.getTraders()) {
//            count += 1;
//        }
//        Assert.assertEquals(testSize, count);
//        Assert.assertEquals(testSize, 5);
//        Assert.assertEquals(testSize, entity.getTraders().length);
//    }
//
//    @Test
//    public void testGetElementAt() {
//        StringBuilder name = new StringBuilder();
//        for (int i = 0; i < entity.getTraders().length; i++) {
//            Trader t = (Trader) tradersList.getElementAt(i);
//            name.append(t.getName()).append("*");
//        }
//        Assert.assertEquals(name.toString(), "Samsung*Apple*Papa Jons*Vlasevskii Boris*Zara*");
//    }
//}
